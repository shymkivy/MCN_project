...
ob_data1 = f_gen_dset(dparams, params, stim_templates, stim_sample='equal')
...
proj_data, exp_var, _, _ = f_run_dred(rates2d_cut, subtr_mean=dred_subtr_mean, method=dred_met)
